...
const Connections = () => {
  const [currentTab, setCurrentTab] = useState("Подписчики");

  const navigate = useNavigate();
  const dataArray = [
    { label: "Подписчики", value: followers, icon: Users },
    { label: "Подписки", value: following, icon: UserCheck },
    { label: "Заявки", value: pendingConnections, icon: UserRoundPen },
    { label: "Приняли заявку", value: connections, icon: UserPlus },
  ];
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Управляй своей сетью и находи новых знакомых
          </p>
        </div>
        {/*Counts*/}
