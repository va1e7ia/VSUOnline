...
const CreatePost = () => {
  ...
  const handleSubmit = async () => {
    if(!images.length && !content){
      return toast.error("Пожалуйста, добавьте текст или изображение для публикации");
    }
    setLoading(true);
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Поделитесь своими мыслями с окружающими
          </p>
        </div>
        {/* form */}
            ...
            <button
              ...
              onClick={() =>
                toast.promise(handleSubmit(), {
                  loading: "Загружается...",
                  success: <p>Опубликовано!</p>,
                  error: <p>Публикация не была добавлена</p>,
                })
              }
